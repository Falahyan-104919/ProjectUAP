        ...
        <div class="card border-warning mb-3" style="width: 50rem;">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?= ($validation->hasError('no_hp')) ? 'is-invalid' : '' ;?>" id="no_hp" name="no_hp" placeholder="No. HP" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control <?= ($validation->hasError('alamat')) ? 'is-invalid' : '' ;?>" id="alamat" name="alamat"placeholder="Alamat Lengkap" autocomplete="off"></textarea>
